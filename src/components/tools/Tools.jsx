...
const Tools = () => {
    return (
        <div>
            ...
            <div className="grid grid-cols-1 mx-auto sm:max-w-screen-sm md:max-w-screen-md md:grid-cols-2 lg:max-w-screen-2xl lg:grid-cols-3 gap-8 mb-12 mt-12 text-center">
